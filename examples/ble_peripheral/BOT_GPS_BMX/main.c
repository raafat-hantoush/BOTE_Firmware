...
#define HEART_RATE_MEAS_INTERVAL         APP_TIMER_TICKS(1000)         //500ms  
...
//                if (index > 1)
//                {
//                    SEGGER_RTT_printf(0,"Ready to send data over BLE NUS \n");
//                    SEGGER_RTT_printf(0,data_array, index);
//
//                    do
//                    {
...
static void advertising_data_set(void)
{
     ...
     else if(m_adv_scan_phy_selected == SELECTION_CODED_PHY)
    {
        ...
        SEGGER_RTT_printf(0,"Setting adv params PHY to CODED .. \n");
        adv_params.primary_phy     = BLE_GAP_PHY_CODED;
        adv_params.secondary_phy   = BLE_GAP_PHY_CODED;
        
        if(m_adv_scan_type_selected == SELECTION_CONNECTABLE)
        {
            SEGGER_RTT_printf(0,"Advertising type set to EXTENDED_CONNECTABLE_NONSCANNABLE_UNDIRECTED \n");
        ...
        {
            SEGGER_RTT_printf(0,"Advertising type set to EXTENDED_NONCONNECTABLE_SCANNABLE_UNDIRECTED \n");
